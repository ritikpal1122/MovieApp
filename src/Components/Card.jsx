      ...
      {isLoading ? (
        <div className="inline-block relative border-2 border-gray-400 overflow-hidden rounded-lg m-1 cursor-pointer min-w-[200px] h-[300px]">
          <SkeletonTheme color="#202020" highlightColor="#444">
            <Skeleton height={300} w={200} duration={2} />
          </SkeletonTheme>
        </div>
      ) : (
        <Link to={`/movie/${movie.id}`} className="text-white underline-none">
          <div className="inline-block m-0 relative border-2 border-gray-400 overflow-hidden rounded-lg m-2  cursor-pointer min-w-[180px] h-[260px] transform transition-transform duration-300 hover:scale-105">
            ...
            />
            <div className="absolute inset-0 flex flex-col justify-end px-4 py-2 bg-gradient-to-t from-transparent to-black opacity-0 transition-opacity duration-200 hover:opacity-100">
